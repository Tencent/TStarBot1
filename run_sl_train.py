...
flags.DEFINE_integer("print_freq", 500, "Frequency to print train loss.")
...
flags.DEFINE_float("value_coef", 0.0, "Value loss coefficent.")
...
flags.DEFINE_integer("save_model_freq", 20000, "Frequency to save model.")
flags.DEFINE_integer("max_sampled_dev_ins", 128000, "Sampled dev instances.")
