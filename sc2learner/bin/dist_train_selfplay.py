...
from sc2learner.envs.selfplay_sc2_env import SelfplayStarCraftIIEnv
...
flags.DEFINE_integer("model_cache_size", 100, "Opponent model cache size.")
flags.DEFINE_float("model_cache_prob", 0.01, "Opponent model cache probability.")
...
def create_selfplay_env(random_seed=None):
  env = SelfplayStarCraftIIEnv(map_name='AbyssalReef',
                               step_mul=FLAGS.step_mul,
                               resolution=16,
                               agent_race='zerg',
                               opponent_race='zerg',
