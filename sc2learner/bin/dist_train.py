...
flags.DEFINE_integer("warmup_size", 1000000, "Warmup size for replay memory.")
...
flags.DEFINE_integer("eps_decay", 200000, "Greedy epsilon decay step.")
flags.DEFINE_integer("eps_decay2", 5000000, "Greedy epsilon decay step.")
